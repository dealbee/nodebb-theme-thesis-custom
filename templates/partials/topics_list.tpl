<ul component="category" class="topic-list" itemscope itemtype="http://www.schema.org/ItemList"
    ...
    {{{each topics}}}
    <li component="category/topic" class="row clearfix category-item {function.generateTopicClass} <!-- IF deleted -->deleted<!-- ENDIF deleted -->"
    ...
    <div class="col-md-6 col-sm-9 col-xs-10 content">
        ...
        <h2 component="topic/header" class="title">
            ...
            <i style="color: #fda34b" component="topic/locked"
               class="fa fa-hourglass-half <!-- IF topics.deleted -->hide<!-- ENDIF topics.deleted --> <!-- IF !topics.locked -->hide<!-- ENDIF !topics.locked -->"
               title="[[thesiscustom:disapproved]]"></i>
            <i style="color: #337ab7" component="topic/moved"
