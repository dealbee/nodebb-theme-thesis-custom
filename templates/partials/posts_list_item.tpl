<li component="post" class="posts-list-item row<!-- IF ../deleted --> deleted<!-- ELSE --><!-- IF ../topic.deleted --> deleted<!-- ENDIF --><!-- ENDIF -->
<!-- IF latestPosts.topic.locked --> locked <!-- ENDIF latestPosts.topic.locked -->" data-pid="{../pid}" data-uid="{../uid}">
